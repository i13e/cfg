...
#        --timepos="w/6:h/2+50" --timestr="%R" --datecolor=e5e9f0 --time-font="Monospace" \
#        --date-font="Monospace" --verif-font="Monospace" --wrong-font="Monospace" \
#        --greeter-font="Monospace" --greetertext="$USER" --greetercolor=e5e9f0 --greeterpos="w/6:h/2-10" \
...
lock() {
	i3lock -n -c 00000000 -t -e -S 1 --date-str="@$(uname -n)" --date-pos="w/2:h/2+90" \
        ...
        --time-pos="w/2:h/2+35" --time-str="%R" --date-color=e5e9f0 --time-font="Monospace" \
        --date-font="Monospace" --verif-font="Monospace" --wrong-font="Monospace" \
        --greeter-font="Monospace:style=Bold" --greeter-text="$USER" --greeter-color=8fbcbb --greeter-pos="w/2:h/2+70" \
        --radius 50 --ring-width 3 --greeter-size=18 --time-size=14 --verif-size=10 --wrong-size=10  --modif-size=9 --modif-pos="w/2:h/2-15" #--no-verify -i
}
